...
```
# 11. sudo gedit 错误：Gtk-WARNING **: cannot open display: :0.0
...
# 14. 使用ssh链接linux主机时，可能出现“Host key verification failed.“的提示，ssh连接不成功。
...
# 28. 使用 AppImageLauncher 轻松运行和集成 AppImage 文件
